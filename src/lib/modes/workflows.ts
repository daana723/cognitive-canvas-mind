...
export const WORKFLOWS: WorkflowTemplate[] = [
  {
    ...
    duration: "20–30 min",
    moduleId: "serendipity-lab",
    seed: "The seed pulling at me, and the directions it could go:",
    steps: [
  ...
  },
  {
    ...
    seed: "The pieces I collected and the echoes I noticed between them:",
    steps: [
  ...
  },
  {
    ...
    duration: "25–40 min",
    moduleId: "editorial",
    seed: "The promise of this work, and the beats that keep it:",
    steps: [
  ...
  },
  {
    ...
    duration: "20–30 min",
    moduleId: "personas",
    seed: "The figure I drew, its name, and what it wants:",
    steps: [
  ...
  },
  {
    ...
    seed: "What I made in the loop, who saw it, and the signal it returned:",
    steps: [

export function ThreadBackground() {
  return (
    ...
    >
      <defs>
        <linearGradient id="lt-thread-grad" x1="0" x2="1" y1="0" y2="1">
        ...
        <radialGradient id="lt-node-grad">
      ...
      {[
        [200, 180], [600, 240], [950, 160], [320, 520], [780, 580], [1050, 460],
      ].map(([cx, cy], i) => (
        <circle
          key={`n-${i}`}
          cx={cx}

import { LIKERT_LABELS, type LikertValue } from "@/lib/spark/questions";
    ...
    <div className="space-y-5">
      <div className="grid grid-cols-5 gap-2 sm:gap-3">
        {VALUES.map((v) => {
          ...
          const size = 36 + (Math.abs(v - 3)) * 6; // 36, 42, 48, 42, 36
          return (
            <button
              key={v}
              type="button"
            ...
            >
              <span
                ...
                style={{
                  ...
                  background: active
                    ? "var(--gradient-thread)"
                    : "oklch(0.24 0.05 278 / 0.4)",
                  boxShadow: active
                    ? "0 0 28px oklch(0.74 0.16 285 / 0.55)"
                    : undefined,
                }}
              >
                <span

    ...
    <main className="relative min-h-screen overflow-hidden pb-32">
      ...
      <section className="relative z-10 mx-auto max-w-3xl px-6 pt-8">
        ...
        <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground fade-up" style={{ animationDelay: "160ms" }}>
          These are experiments, not prescriptions. Try one. Tick the steps as you go —
          your progress stays on this device. When you're ready, hand the work to the Loom.
        </p>
        <p className="mt-4 text-xs leading-relaxed text-muted-foreground/80 fade-up" style={{ animationDelay: "200ms" }}>
          Note: everything here is generated by local rules on your device — no AI model,
          no account, nothing sent anywhere. A real engine can be connected later.
        </p>
      </section>

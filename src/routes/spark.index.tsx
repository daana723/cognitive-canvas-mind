  ...
  head: () => ({
    meta: [
      { title: "SPARK — a reflective mirror for nonlinear thinkers" },
      {
        name: "description",
        content:
          "A guided reflection. Recognize patterns in how you create, sense, decide, and move through ideas. Not a quiz, not an assessment.",
      },
      { property: "og:title", content: "SPARK — a reflective mirror" },
      {
        property: "og:description",
        content: "A deep reflection for nonlinear thinkers. Non-diagnostic. Local-first.",
      },
    ],
  }),
    ...
    <section className="mx-auto max-w-3xl px-6 pt-6">
      <div className="glass-panel rounded-3xl p-10 sm:p-14 text-center fade-up">
        ...
        <p className="mx-auto mt-6 max-w-xl text-base text-muted-foreground leading-relaxed">
          A guided reflection for nonlinear thinkers. Not a quiz, not an assessment. You'll move
          through {PROMPTS.length} short prompts, then an optional {CURRENT_PROMPTS.length}-prompt
          reading of the five currents. What surfaces at the end is a pattern sketch — motifs and
